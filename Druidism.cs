...
namespace Druidism
{
    ...
    public class Druidism : Mod
    {
        ...
        public override void PatchMod()
        {
            ...
            {
                string tier = "\"Druidism;Друидизм;Druidism;德鲁伊;Druidismus;Druidismo;Druidisme;Druidismo;Druidismo;Druidyzm;Druidizm;ドルイド信仰;드루이드주의;\", ";
                string hover =
                    ...
                    "追寻天人合一，聆听苍穹之语，唤醒灵魂深处的野性本能。##~y~能力要义：~/~#~w~支援~/~, ~w~治疗~/~, ~w~召唤~/~, ~w~变形~/~;" +
            ...
            {
                string skills =
                    "\"stick_to_snake;Палка в змею;Stick to Snake;木枝化蛇;Stock zur Schlange;Palo a Serpiente;Bâton en Serpent;Bastone in Serpente;Graveto em Serpente;Kij w Węża;Yılana Dönüş;棒を蛇へ;막대를 뱀으로;\"," +
                    "\"animal_friendship;Дружба с животными;Animal Friendship;自然亲和;Tierfreundschaft;Afinidad Animal;Amitié Animale;Affinità Animale;Afinidade Animal;Przyjaźń Zwierząt;Hayvan Dostluğu;動物との親和;동물 친화;\"," +
                    "\"celestial_strike;Небесный удар;Celestial Strike;天穹之怒;Himmlischer Schlag;Golpe Celestial;Frappe Céleste;Colpo Celestiale;Golpe Celestial;Niebiańskie Uderzenie;Göksel Darbe;天の一撃;천상의 일격;\"," +
                    "\"attune_the_sky;Настройка Неба;Attune to the Sky;天象共鸣;Einstimmung des Himmels;Sintonizar el Cielo;Accorder le Ciel;Sintonizzarsi al Cielo;Sintonizar o Céu;Dostrojenie Nieba;Gökyüzüyle Uyum;空との調和;하늘과의 조화;\"," +
                    "\"attune_the_earth;Настройка Земли;Attune to the Earth;地脉共鸣;Einstimmung der Erde;Sintonizar la Tierra;Accorder la Terre;Sintonizzarsi alla Terra;Sintonizar a Terra;Dostrojenie Ziemi;Toprakla Uyum;大地との調和;대지와의 조화;\"," +
                    "\"entangling_grasp;Опутывающая хватка;Entangling Grasp;根须缠缚;Fesselnder Griff;Agarre Enredador;Poigne Entravante;Presa Avvolgente;Agarre Enredante;Krępujący Chwyt;Sarmalayan Kavrayış;絡みつく手;얽히는 손아귀;\"," +
                    "\"bestial_vigor;Звериная сила;Bestial Vigor;野性活力;Bestiale Kraft;Vigor Bestial;Vigueur Bestiale;Vigore Bestiale;Vigor Bestial;Bestialska Witalność;Yabanıl Güç;獣の活力;야수의 활력;\"," +
                    "\"wild_shape;Звериная форма;Wild Shape;兽化变形;Tiergestalt;Forma Salvaje;Forme Sauvage;Forma Selvatica;Forma Selvagem;Dzika Forma;Vahşi Biçim;野獣化;야성 변신;\"," +
                    ...
                    "\"butterflies_to_hornets;Бабочки в жалящих;Butterflies to Hornets;羽蝶化蜂;Schmetterlinge zu Hornissen;Mariposas a Avispones;Papillons en Frelons;Farfalle in Calabroni;Borboletas em Vespões;Motyle w Szerszenie;Kelebekten Eşek Arısına;蝶からスズメバチ;나비를 말벌로;\"," +
                    ...
                    "\"bear_aspect;Аспект Медведя;Bear Aspect;巨熊化身;Aspekt des Bären;Aspecto del Oso;Aspect de l’Ours;Aspetto dell’Orso;Aspecto do Urso;Aspekt Niedźwiedzia;Ayı Biçimi;熊の相;곰의 상;\",";
            ...
            static IEnumerable<string> HerbalistTrainer(IEnumerable<string> input)
            {
                ...
                string herbalist =
                    ...
                    "草木有心，鸟兽有灵，那些久已失传的古老技艺，在我这都还记着。这么多年来，是我让这传承延续至今。若你愿付出些许酬劳，我便可为你展现这天地间，那些你从未想象过的景色。;" +
            ...
            Msl.LoadGML("gml_Object_o_inv_consum_Other_24")
                ...
                .ReplaceBy(
                    ...
                    "    // Apply Vigor once\r\n" +
                    "    if (_bv_rawmeat)\r\n" +
                    "        scr_effect_create(o_b_fresh, 120)\r\n" +
                    "\r\n" +
